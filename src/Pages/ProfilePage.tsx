...
function ProfilePage() {
   ...
   const handleSaveProfile = async () => {
    ...
    if(!email || !username) toastErr("Email or username can't be emmpty")
   ...
   const handleDeleteAccount = async () => {
    if (
      window.confirm(
        `Are your sure to delete your account ${username}? This can't be reversed`
      )
    ) {
  ...
  return (
    <div
      className="bg-white flex flex-col gap-5 shadow-md max-w-2xl rounded-xl py-5 px-6 md:p-10
