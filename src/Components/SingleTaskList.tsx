...
import { collapseAllTask, taskListSwitchEditMode } from "../Redux/taskListSlice";
...
const SingleTaskList = forwardRef(
  ({ singleTaskList }: SingleTaskListPropTypes, ref: React.LegacyRef<HTMLDivElement> | undefined
    ...
    return (
      <div ref={ref} className="relative">
        <div
          className="bg-[#d3f0f9] w-full md:w-[400px] drop-shadow-md rounded-md min-h-[150px]
        overflow-hidden"
        >
          <div className="flex flex-wrap items-center justify-center md:gap-10 bg-gradient-to-tr from-myBlue to-myPink bg-opacity-70 p-3 text-white text-center">
            ...
            <div>
              ...
              className={`${allCollapsed ? "rotate-100" : "rotate-0"}`}/>
            </div>
          </div>
          {tasksLoading ? (
            <TaskListTasksLoader />
