...
function SingleListLoader() {
  return (
    <div className="relative bg-gray-200 shadow rounded-md max-w-sm w-full">
      <div className="animate-pulse flex flex-ccol">
...
const SingleMessageLoader = () => {
  return (
    <div className="animate-pulse flex flex-col gap-10">
      ...
      <div className="bg-gray-300 h-12 w-full mb-5 rounded-full rounded-bl-full border-2 border-white self-end max-w-sm"></div>
    </div>
  );
};
